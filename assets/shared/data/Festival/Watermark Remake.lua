function onCreate()
                     makeLuaText('watermark', songName .. " | Created By Emanuel", 0, 0, 697); -- You can edit the created by Prisma Text just dont change anything else
	makeLuaText('psychtitle', ':)', 2268, 30, 0);
